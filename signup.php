...
<div class="signup-form">
    <form  action="handlesignup.php" method="post">
        ...
        <div class="form-group">
        	<input type="email" class="form-control" name="signup" placeholder="Email" required="required">
        </div>
		<div class="form-group">
            <input type="password" class="form-control" name="rpassword" placeholder="Password" required="required">
        </div>
		<div class="form-group">
